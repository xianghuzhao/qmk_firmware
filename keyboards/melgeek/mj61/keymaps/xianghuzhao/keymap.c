...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_60_ansi(
		...
		_______,    _______, KC_UP,    _______,  _______, _______, KC_CALC, _______, S(KC_INS), KC_INS,  KC_PSCR, KC_SCRL, KC_PAUS, _______,
		KC_CAPS,    KC_LEFT, KC_DOWN,  KC_RGHT,  _______, _______, _______, C(KC_C), C(KC_X), KC_DEL,  KC_HOME, KC_PGUP,          _______,
